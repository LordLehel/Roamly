...
export const CONST_EVENTS_HEADER = 'Events';
export const CONST_EVENT_PREVIEW_HEADER = 'Events - extended';
export const CONST_NO_EVENTS_MSG = 'No events for this day.';
export const CONST_SELECT_EVENT_PROMPT = 'Select an event to view details.';
export const CONST_PRIVATE_LBL = 'Private';
export const CONST_GROUP_EVENT_LBL = 'Group event';
export const CONST_CREATOR_LBL = 'Creator:';
export const CONST_DATE_LBL = 'Date:';
export const CONST_TIME_LBL = 'Time:';
