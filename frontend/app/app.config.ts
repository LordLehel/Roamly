...
export default defineAppConfig({
  ui: {
    ...
    button: {
      variants: {
        variant: {
          glass: 'h-10 px-6 text-md ring-1 ring-green-800 bg-green-950/50 hover:bg-green-800 hover:ring-1 hover:ring-green-500 text-green-50 transition-colors backdrop-blur-md',
          glassOutline: 'border border-green-500/50 px-4 py-2 rounded-md bg-green-950/50 hover:bg-green-800 text-green-50 transition-colors backdrop-blur-md',
        },
      },
    },
