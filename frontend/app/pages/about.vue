  ...
  >
    ...
    <main class="flex-1 flex flex-col items-center px-6 py-12 gap-16 relative z-10">
      ...
      <section class="flex flex-col items-center text-center mt-10 max-w-3xl">
        <h1 class="text-4xl font-bold text-[#FAF9F6] tracking-wide">About Roamly</h1>
        ...
        <p class="mt-10 text-lg text-[#FAF9F6] font-medium opacity-90 leading-relaxed">
          ...
          about helping groups plan their trips efficiently and enjoyably. Our goal is to make
          travel planning a breeze, so you can focus on creating unforgettable memories.
        </p>
      </section>
    </main>
